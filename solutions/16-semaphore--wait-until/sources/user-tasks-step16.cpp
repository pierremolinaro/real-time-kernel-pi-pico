...
static Semaphore task0Wait (0) ;
static Semaphore task2Wait (0) ;
static Semaphore mutexLCD (1) ;

//--------------------------------------------------------------------------------------------------

static void task0 (USER_MODE) {
  const bool timeOut = !task0Wait.P_until (MODE_ 1000) ;
...
static void task2 (USER_MODE) {
  const bool timeOut = !task2Wait.P_until (MODE_ 3000) ;
  for (uint32_t i=0 ; i < 10 ; i++) {
