...
def generate_svc_handler () :
  ...
  sCode += "  ldr   r0, =var.running.task.control.block.ptr\n"
  sCode += "  ldr   r0, [r0]\n"
  ...
  sCode += "  ldr   r0, =var.background.task.context\n"
  sCode += "  mov   r4, lr\n"
  sCode += "  mrs   r5, psp\n"
  sCode += "  stm   r0!, {r4, r5}\n"
  sCode += "context.has.been.saved:\n"
  sCode += "//----------------------------------------- Here, R5 contains PSP\n"
...
def buildServiceCode (serviceList, boolServiceSet, interruptServiceList, interruptDictionary) :
  ...
  for interruptServiceName in interruptServiceList :
    ...
    sFile += "  ldr   r0, =var.running.task.control.block.ptr\n"
    sFile += "  ldr   r0, [r0]\n"
    ...
    sFile += "  ldr   r0, =var.background.task.context\n"
    sFile += "  mov   r1, lr\n"
    sFile += "  mrs   r2, psp\n"
    sFile += "  stm   r0!, {r1, r2}\n"
