...
static void acquireSpinLock1 (FAULT_MODE) {
//   #define spinlock1 *((volatile uint32_t *) (SIO_BASE + SIO_SPINLOCK1_OFFSET))
//   while (spinlock1 == 0) {
//   }
  sio_hw->fifo_wr = 1 ;  // Page 50, write any data to FIFO for interrupting other CPU
}
